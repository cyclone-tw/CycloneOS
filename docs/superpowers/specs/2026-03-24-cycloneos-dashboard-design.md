...
| Google Drive (學校) | user@school.edu.tw 雲端硬碟 | OAuth2 | `SCHOOL_GMAIL_CLIENT_ID`, `SCHOOL_GMAIL_CLIENT_SECRET`, `SCHOOL_GMAIL_REFRESH_TOKEN` |
...
- 接入 Notion CY Task v2（DB ID: `<YOUR_NOTION_DB_ID>`）
