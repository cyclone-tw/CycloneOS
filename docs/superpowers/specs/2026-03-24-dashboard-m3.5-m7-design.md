...
| user@school.edu.tw | 學校（公文、IEP、教材、與同事共編資料夾） | `~/Library/CloudStorage/GoogleDrive-user@school.edu.tw/我的雲端硬碟/` |
...
const DRIVE_ACCOUNTS: DriveAccount[] = [
  ...
  },
  {
    ...
    label: '學校',
    localBasePath: '/Users/username/Library/CloudStorage/GoogleDrive-user@school.edu.tw/我的雲端硬碟',
    outputFolder: 'CycloneOS-output',
  },
];
```
